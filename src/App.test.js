...
describe("App", () => {
  ...
  beforeEach(() => {
    ...
    app = new ApplicationRunner(renderer, productos)

    app.launch()
  })

  it("debe ayudar al usuario a mantener registro de los productos que necesita", async () => {
    productos.registrar.mockResolvedValue()
  ...
  it("debe comunicar que hubo un error registrando al producto", async () => {
    productos.registrar.mockRejectedValue(new Error("un error"))
